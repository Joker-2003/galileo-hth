...
from server.knowledge.base import BaseComponent, Document, Param
from server.knowledge.indices.extractors import BaseDocParser
from server.knowledge.indices.splitters import BaseSplitter, TokenSplitter
from server.knowledge.loaders import (
    AdobeReader,

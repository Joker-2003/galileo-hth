...
from server.knowledge.base import BaseComponent
from server.knowledge.base.schema import Document, IO_Type
...
class SimpleLinearPipeline(BaseComponent):
    ...
    Example Usage:
        ```python
        from server.knowledge.llms import LCAzureChatOpenAI, BasePromptComponent
...
class GatedLinearPipeline(SimpleLinearPipeline):
    ...
    Usage:
        ...
        from server.knowledge.llms import LCAzureChatOpenAI, BasePromptComponent
        from server.knowledge.parsers import RegexExtractor

...
def load_pdf_text(file_content: bytes) -> str:
    """
    Loads text from a PDF content given as bytes.

    :param file_content: The bytes content of the PDF.
    :return: Extracted text from the PDF.
    """
    with BytesIO(file_content) as file_stream:
        loader = BytesIOPyMuPDFLoader(file_stream)

...
const WorkspaceNavbar = ({workspaceid}) => {
  ...
  const handleAddFlashcards = () => {
    router.push(`/dashboard/${workspaceid}/flashcards/create`); // Navigate to the create flashcards page
  };
        ...
        <div className="md:hidden bg-white dark:bg-black border-t dark:border-neutral-800">
          <div className="flex flex-col items-center space-y-4 py-4">
            <HoverBorderGradient
              ...
              onClick={handleAddFlashcards} // Add flashcards on mobile menu too
            >
